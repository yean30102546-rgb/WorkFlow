---
title: "How to Debug Your Code, the Right Way — Like a Pro with Examples"
source: "https://levelup.gitconnected.com/how-to-debug-code-from-github-like-a-pro-with-examples-bcf0646f44ef"
author:
  - "[[Justice Ekemezie]]"
published: 2023-03-14
created: 2026-05-21
description: "Debugging code on Github is easier than you think! This tutorial walks you through the process, with helpful tips and tricks along the way. Complete with detailed examples and expert advice."
tags:
  - "clippings"
---
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*CMmzM54JcNEik6pO)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*zfN8eNDD-XGKFHW2ktbzxg.png)

Screenshot Highlighting tRPC Issues on Github
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*N5wIIeb_GRqNXmeBMJaqxw.png)

Screenshot Highlighting the Search box for tRPC issues on Github
...
- **Github’s discussions feature to ask for help**
...
## Get Justice Ekemezie’s stories in your inbox
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*jm_1IEf94zeXfPJU25r1Jg.png)

tRPC Example result in Github Search

Of course, I had to use different search terms before I could get the correct one. The result?

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*pBhTA7aPtupKRLps4FSJlQ.png)

Screenshot of a Solution after Searching on Github Issues
...
Did you find this article insightful? Follow me on Medium at

[Justice Ekemezie](https://medium.com/u/5751684b99da?source=post_page---user_mention--bcf0646f44ef---------------------------------------)

to stay up-to-date with my latest articles. In future articles, I will discuss the significance of the rules of hooks, why they are important, and how to adhere to them. Additionally, you can [follow me on Twitter at @ttebify](https://twitter.com/ttebify) for motivation and access to valuable resources. I look forward to connecting with you!

## Resources:

The Rules of Hook from the React Docs: [Rules of Hooks — React (reactjs.org)](https://reactjs.org/docs/hooks-rules.html)

I love this project 😍 Envless— The most secure, open source and frictionless way to share and manage app secrets across teams ([https://envless.dev/](https://envless.dev/))